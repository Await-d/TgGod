...
from ..services.complete_health_monitoring import (
    ...
    stop_complete_health_monitoring,
...
async def get_monitoring_config():
    ...
    try:
        ...
        return {"success": True, "data": config_info, "message": "获取监控配置成功"}
    except Exception as e:
        ...
        return {
            ...
            "data": {
                ...
                "cleanup_status": {
                    ...
                    "cleanup_thread_active": temp_file_manager._cleanup_thread.is_alive()
                    if temp_file_manager._cleanup_thread
                    else False,
                },
            },
...
async def cleanup_temp_files(
    force: bool = Query(False, description="是否强制清理所有文件"),
):
    """手动清理临时文件"""
    try:
        from ..core.temp_file_manager import temp_file_manager
...
async def list_temp_files(
    purpose: Optional[str] = Query(None, description="按用途过滤文件"),
):
    """列出临时文件"""
    try:
        from ..core.temp_file_manager import temp_file_manager
